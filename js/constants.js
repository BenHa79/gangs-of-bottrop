...
const EQUIP_SLOTS = [
  ...
  { id:'körper',     label:'Brust',       icon:'🥼' },
  { id:'waffe',      label:'Waffe',       icon:'🔫' },
  { id:'hose',       label:'Hose',        icon:'👖' },
  { id:'hand',       label:'Ring',        icon:'💍' },
  { id:'füße',       label:'Schuhe',      icon:'👟' },
  { id:'handschuhe', label:'Handschuhe',  icon:'🧤' },
  { id:'gürtel',     label:'Gürtel',      icon:'⛓️' },
...
const STAT_LABELS = {
  str: { label:'Stärke',          abbr:'STÄ', icon:'💪' },
  end: { label:'Ausdauer',        abbr:'AUS', icon:'🛡️' },
  ges: { label:'Geschicklichkeit',abbr:'GES', icon:'🤸' },
  lck: { label:'Glück',           abbr:'GLÜ', icon:'🍀' },
  inf: { label:'Einfluss',        abbr:'EIN', icon:'🎩' },
  rep: { label:'Respekt',         abbr:'RES', icon:'🔥' },
  cha: { label:'Charisma',        abbr:'CHA', icon:'🎭' },
};
